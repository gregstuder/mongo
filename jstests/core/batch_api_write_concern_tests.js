 ...
 */
var port = allocatePorts( 1, 32000 )[ 0 ];
var baseName = "test";
var m = startMongod("--nojournal", "--port", port, "--dbpath", MongoRunner.dataPath + baseName, "--nohttpinterface", "--bind_ip", "127.0.0.1" );
var db = m.getDB(baseName);

var collectionName = "batch_write_protocol";
var coll = db.getCollection(collectionName);

jsTest.log("Starting ordered batch tests...");
